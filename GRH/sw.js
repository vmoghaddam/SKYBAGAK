const cacheName = 'cache-v950007';
const dynamicCache = 'dyn-950007';
const assets = [
    '/',
     '/pwa.js',
   // '/offline.html',
    '/index.html',
    'manifest.json',
    	'app/views/toadd.html?vx=8',
	'app/views/forms.html?vx=8',
	'app/views/camera.html?vx=8',
	'app/views/ldgadd.html?vx=8',
	'app/views/library.html?vx=8',
	'app/views/document.html?vx=8',
    'app/views/calendar.html?vx=8',
    'app/views/logAdd.html?vx=8',
    'app/views/vrAdd.html?vx=8',
    'app/views/asrAdd.html?vx=8',
	'app/views/drAdd.html?vx=8',
	  'app/views/ofpAdd.html?vx=8',
	  'app/views/signAdd.html?vx=8',
	  'app/views/jl.html?vx=8',
	 'app/views/profileview.html?vx=8',
	'app/views/certificate.html?vx=8',
	 
	'app/views/stat.html?vx=8',
	'app/views/rptflightssimple.html?vx=8',
	'app/views/mb.html?vx=8',
    'app/views/taf.html?vx=8',
    'app/views/metar.html?vx=8',
    'app/views/notam.html?vx=8',
     'app/views/flights.html?vx=8' ,
	'pdfjsmodule/pdfviewernew.html?vx=8',
	 'app/views/imageviewer.html?vx=8',
    'app/views/header.html?vx=8',
    'app/views/menu.html?vx=8',
    '/app/views/login.html?vx=8',
    '/app/views/home.html?vx=8',
    //'app/views/logAdd.html',
    'app/views/footer.html?vx=8',
    '/app/app.js?vx=8',
    '/app/db.js?vx=8',
    ...
    '/content/css/main.css?vx=8',
    '/content/css/core-ui.css',
    '/content/css/dx-hack.css?vx=8',
    ...
    '/scripts/config.js?vx=8',
    '/scripts/core.js?vx=8',
    '/scripts/kit.fontawsome.js',
    '/scripts/dexie.js',
    '/app/services/authInterceptorService.js?vx=8',
    '/app/services/authService.js?vx=8',
    '/app/services/activityService.js?vx=8',

    '/app/services/testService.js?vx=8',
    '/app/services/tokensManagerService.js?vx=8',
    '/app/services/generalService.js?vx=8',
    '/app/services/notificationService.js?vx=8',
    '/app/services/libraryService.js?vx=8',
    '/app/services/flightService.js?vx=8',
	 '/app/services/statService.js?vx=8',
	'/app/services/mbService.js?vx=8',
    '/app/controllers/indexController.js?vx=8',
    //'/app/controllers/appsController.js',
     '/app/controllers/footerController.js?vx=8',
     '/app/controllers/homeController.js?vx=8',
    '/app/controllers/loginController.js?vx=8',
	'/app/controllers/toadd.js?vx=8',
	'/app/controllers/forms.js?vx=8',
	'/app/controllers/camera.js?vx=8',
			'/app/controllers/ldgadd.js?vx=8',
			'/app/controllers/appDocumentController.js?vx=8',
		'/app/controllers/appLibraryController.js?vx=8',
	'/app/controllers/mbController.js?vx=8',
   ...
   // '/app/controllers/filterController.js',
    ...
    '/app/controllers/logAdd.js?vx=8',
	 '/app/controllers/ofpAdd.js?vx=8',
	 '/app/controllers/signAdd.js?vx=8',
	'/app/controllers/jl.js?vx=8',
	'/app/controllers/profileview.js?vx=8',
	'/app/controllers/appCertificateController.js?vx=8',
	'/app/controllers/statController.js?vx=8',
		'/app/controllers/rptflightssimple.js?vx=8',
	//'/app/controllers/appDocumentController.js?vx=8',
	
	
   // '/app/controllers/vrAdd.js?vx=8',
    //'/app/controllers/asrAdd.js?vx=8',
    '/app/controllers/taf.js?vx=8',
    '/app/controllers/metar.js?vx=8',
    '/app/controllers/notam.js?vx=8',
    //'/app/controllers/reports.js',
    //'/app/controllers/docViewer.js',
 '/pdfjsmodule/pdfviewernew.js?vx=8',
	
    '/app/controllers/epLogBook.js?vx=8', 
	 '/app/controllers/imageviewer.js?vx=8',
    '/app/controllers/calendarController.js?vx=8', 
