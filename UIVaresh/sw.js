const cacheName = 'cache-v1050020';
const dynamicCache = 'dyn-1050020';
const assets = [
    '/',
     '/pwa.js',
   // '/offline.html',
    '/index.html',
    'manifest.json',
    	'app/views/toadd.html?vx=17',
	'app/views/forms.html?vx=17',
	'app/views/camera.html?vx=17',
	'app/views/ldgadd.html?vx=17',
	'app/views/library.html?vx=17',
	'app/views/document.html?vx=17',
    'app/views/calendar.html?vx=17',
    'app/views/logAdd.html?vx=17',
    'app/views/vrAdd.html?vx=17',
    'app/views/asrAdd.html?vx=17',
	'app/views/drAdd.html?vx=17',
	  'app/views/ofpAdd.html?vx=17',
	  'app/views/signAdd.html?vx=17',
	  'app/views/jl.html?vx=17',
	 'app/views/profileview.html?vx=17',
	'app/views/certificate.html?vx=17',
	 
	'app/views/stat.html?vx=17',
	'app/views/rptflightssimple.html?vx=17',
	'app/views/mb.html?vx=17',
    'app/views/taf.html?vx=17',
    'app/views/metar.html?vx=17',
    'app/views/notam.html?vx=17',
     'app/views/flights.html?vx=17' ,
	'pdfjsmodule/pdfviewernew.html?vx=17',
	 'app/views/imageviewer.html?vx=17',
    'app/views/header.html?vx=17',
    'app/views/menu.html?vx=17',
    '/app/views/login.html?vx=17',
    '/app/views/home.html?vx=17',
    //'app/views/logAdd.html',
    'app/views/footer.html?vx=17',
    '/app/app.js?vx=17',
    '/app/db.js?vx=17',
    ...
    '/content/css/main.css?vx=17',
    '/content/css/core-ui.css',
    '/content/css/dx-hack.css?vx=17',
    ...
    '/scripts/config.js?vx=17',
    '/scripts/core.js?vx=17',
    '/scripts/kit.fontawsome.js',
    '/scripts/dexie.js',
    '/app/services/authInterceptorService.js?vx=17',
    '/app/services/authService.js?vx=17',
    '/app/services/activityService.js?vx=17',

    '/app/services/testService.js?vx=17',
    '/app/services/tokensManagerService.js?vx=17',
    '/app/services/generalService.js?vx=17',
    '/app/services/notificationService.js?vx=17',
    '/app/services/libraryService.js?vx=17',
    '/app/services/flightService.js?vx=17',
	 '/app/services/statService.js?vx=17',
	'/app/services/mbService.js?vx=17',
    '/app/controllers/indexController.js?vx=17',
    //'/app/controllers/appsController.js',
     '/app/controllers/footerController.js?vx=17',
     '/app/controllers/homeController.js?vx=17',
    '/app/controllers/loginController.js?vx=17',
	'/app/controllers/toadd.js?vx=17',
	'/app/controllers/forms.js?vx=17',
	'/app/controllers/camera.js?vx=17',
			'/app/controllers/ldgadd.js?vx=17',
			'/app/controllers/appDocumentController.js?vx=17',
		'/app/controllers/appLibraryController.js?vx=17',
	'/app/controllers/mbController.js?vx=17',
   ...
   // '/app/controllers/filterController.js',
    ...
    '/app/controllers/logAdd.js?vx=17',
	 '/app/controllers/ofpAdd.js?vx=17',
	 '/app/controllers/signAdd.js?vx=17',
	'/app/controllers/jl.js?vx=17',
	'/app/controllers/profileview.js?vx=17',
	'/app/controllers/appCertificateController.js?vx=17',
	'/app/controllers/statController.js?vx=17',
		'/app/controllers/rptflightssimple.js?vx=17',
	//'/app/controllers/appDocumentController.js?vx=17',
	
	
   // '/app/controllers/vrAdd.js?vx=17',
    //'/app/controllers/asrAdd.js?vx=17',
    '/app/controllers/taf.js?vx=17',
    '/app/controllers/metar.js?vx=17',
    '/app/controllers/notam.js?vx=17',
    //'/app/controllers/reports.js',
    //'/app/controllers/docViewer.js',
 '/pdfjsmodule/pdfviewernew.js?vx=17',
	
    '/app/controllers/epLogBook.js?vx=17', 
	 '/app/controllers/imageviewer.js?vx=17',
    '/app/controllers/calendarController.js?vx=17', 
