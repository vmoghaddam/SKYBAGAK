...
var serviceBase2 ='https://sbapi.apvaresh.com/api/';//'https://api.sbvaresh.ir/api/';
//var serviceBase3 ='https://fbpocket.ir/service/api/';
var serviceBase3 ='https://sbapi.apvaresh.com/api/';//'https://api.sbvaresh.ir/api/';
var mbService ='https://sbapi.apvaresh.com/api/';//'https://api.sbvaresh.ir/api/';
...
var serviceBaseAPI = 'https://api.apvaresh.ir/';
var routeManuals ='https://sb.varesh.click/upload/RouteManuals/'; //'https://sbvaresh.ir/upload/RouteManuals/';
var apiWeather='https://coreweather.varesh.click/api/weather/';
var apiOFP='https://ofp.vrh.skybag.click/api/';
var apiapsb='https://apiapsb.apvaresh.com/';


var apinet='https://apinet.apvaresh.com/';
var apilib='https://apilib.apvaresh.com/';
...
app.run(['authService', 'activityService', '$rootScope', '$location', '$templateCache', 'generalService', 'localStorageService', '$window', 'flightService', '$interval',function (authService, activityService, $rootScope, $location, $templateCache, generalService, localStorageService, $window,flightService,$interval) {
	...
	$rootScope.Operator='VARESH AIRLINES';
